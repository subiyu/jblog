		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
					...
					<li><a
						href="${pageContext.request.contextPath}/${id }/admin/write">글작성</a></li>
				</ul>
				<form action="${pageContext.request.contextPath}/${id }/admin/update" method="post" enctype="multipart/form-data">
