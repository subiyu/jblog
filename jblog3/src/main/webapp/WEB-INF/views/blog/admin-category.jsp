		...
		<div id="wrapper">
			<div id="content" class="full-screen">
				<ul class="admin-menu">
		      	...
		      	<table class="admin-cat">
		      		...
		      		<c:forEach items='${list }' var='vo' varStatus="status">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/${id }/admin/category/delete?no=${vo.no }&postCount=${vo.postCount }">
      			...
      			<form id="add_form" action="${pageContext.request.contextPath}/${id }/admin/category/add" method="post">
